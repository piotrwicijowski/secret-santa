...
namespace SecretSanta.Functions
{
    public static class DrawAGiftCSharp
    {
        ...
        [FunctionName("DrawAGiftCSharp")]
        public static void Run([TimerTrigger("0 0 0 25 12 *")]TimerInfo myTimer, ILogger log)
        {
